...
def main():
    ...
    historical_data = fetch_data(api, "EUR_USD", 1500, "H1")
    ...
    check_positions_and_sell(api, account_id, "EUR_USD", next_price_prediction, last_known_price)
    ...
    if next_price_prediction > last_known_price:
        ...
        place_order(api, account_id, "EUR_USD", 100, 0.001)  # Example: Buying 100 units
    else:
